...
if __name__ == '__main__':
    ...
    norm = plt.Normalize(vmin=0.8457957853935549, vmax=8.664567811663979)  # 这里假设数值范围为 [0, 1]，根据实际情况调整
    ...
    values = [1.0, 4.5, 8.0]
    sizes = [values[0] * 70, values[1] * 70, values[2] * 70]  # 泡泡大小
    ...
    plt.savefig(r'D:\LW\ABM\OutputData\Result\pic\sigma=1\Inflow\NumPerShelter\mismatch_inflow_area(legend).pdf', dpi=300)
